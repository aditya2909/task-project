        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 rounded-xl p-4">
                {showToast && (
                    ...
                    >
                        {toastType === 'success' ? <CheckCircle2 className="h-5 w-5" /> : <XCircle className="h-5 w-5" />} <span>{toastMessage}</span>
                    </div>
                )}
                    ...
                    {lists.map((list) => (
                        <Card key={list.id} className="hover:bg-accent/50 transition-colors">
                            ...
                            <CardContent>
                                ...
                                {list.tasks_count !== undefined && <p className="text-muted-foreground text-sm">Tasks: {list.tasks_count}</p>}
                            </CardContent>
                        </Card>
                    ))}
                </div>
